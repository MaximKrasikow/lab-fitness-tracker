...
class Training:
    ...
    def __init__(self,
        ...
        self.action = action  #  Количество действий (шагов или гребков)
        self.duration = duration  # Продолжительность тренировки в часах
        self.weight = weight  # вес спортсмена

    def get_distance(self) -> float:
        """Рассчитывание дистанции тренировки в километрах."""
    ...
    def get_spent_calories(self) -> float:
        ...
        Данный метод реализуется в классах-наследниках.
        """
        pass
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        """Рассчитывание количества калорий, потраченных при беге."""
...
def read_package(workout_type: str, data: list) -> Training:
    """Создание объекта тренировки на основе входных данных."""
    workout_codes = {
        'SWM': Swimming,
        'RUN': Running,
        'WLK': SportsWalking
